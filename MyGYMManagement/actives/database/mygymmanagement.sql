...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2021 a las 07:31:19
...
INSERT INTO `routine_difficulty` (`cod_difficulty`, `type`, `color`) VALUES
(1, 'Principante', 'Verde'),
(2, 'Intermedia', 'Amarillo'),
(3, 'Avanzada', 'Rojo');
...
(5, 1, 13, 'blue', 1, 0, 0, 1, 0, 1, 0),
(6, 1, 9, 'red', 0, 0, 0, 0, 0, 0, 0),
(7, 1, 16, 'red', 0, 0, 0, 0, 0, 0, 0);
...
--
ALTER TABLE `bmi_calc`
  MODIFY `cod_bmi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `routine`
  MODIFY `cod_routine` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `routine_exercise`
  MODIFY `cod_routine_exercise` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `user_routine`
  MODIFY `cod_user_routine` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
